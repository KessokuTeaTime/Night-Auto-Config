...
public class NightAutoConfig implements ClientModInitializer {
	...
	public void onInitializeClient() {
        if (FabricLoader.getInstance().isDevelopmentEnvironment()) {
            ...
            AutoConfig.register(NightExampleConfig.class, ConfigType.TOML.serializer(builder -> builder.preserveInsertionOrder().autosave()));
            AutoConfig.register(ExampleConfig.class, PartitioningSerializer.wrap(ConfigType.TOML.serializer(builder -> builder.preserveInsertionOrder().autosave())));
        }
    }
}
